...
--Variablen mit Spalten der T1 und Spalte @s f r Summen
...
--Cursor  ffnen
open #c
	-- solange durchlaufen und f llen  bis Ende
	while (1=1)
		begin
...
SELECT id, SUM(x) OVER (ORDER BY id ROWS UNBOUNDED PRECEDING) Summe FROM T1